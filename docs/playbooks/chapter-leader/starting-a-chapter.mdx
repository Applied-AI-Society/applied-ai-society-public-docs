...
If your city is not on the map yet, that is often the best reason to start something. We are looking for the person who decides to be the [soul of their scene](/docs/concepts/soul-of-a-scene).
...
- [Soul of a Scene](/docs/concepts/soul-of-a-scene) -- why the person who decides to hold the thread is the bottleneck, not the city's demographics
