...
description: "A step-by-step guide to building your personal AI-operated business OS for legacy, strategic clarity, and compounding context."
---
...
For the full philosophy behind why documented truth matters, see [Legacy](/docs/legacy) and [Why It Matters](/docs/legacy/why-it-matters). This playbook is the practical "how to start" companion to those ideas.
...
**This tutorial is not an Anthropic ad.** We default to Claude Code because it is currently the best [harness](/docs/concepts/harness-engineering) for this workflow. But the entire point of the MVJ architecture is that you are not locked in. You have options at every level:

- **Different harnesses.** Claude Code is one harness. Others exist: [OpenCode](https://github.com/opencode-ai/opencode), Aider, Cursor, Windsurf, and more. They all read files and run commands. The instructions in this tutorial default to Claude Code, but the overall usage patterns (brain dumps, user profiles, skill files, relationship files) work with any harness that can read your workspace.
...
- **Open source models you run yourself.** Open source AI models are getting remarkably good, remarkably fast, and many of them can be run entirely on your own hardware with zero data leaving your machine. New ones come out every few weeks. Check the [Open LLM Leaderboard](https://vellum.ai/open-llm-leaderboard) or [Open WebUI Leaderboard](https://openwebui.com/leaderboard) for current rankings.

The competitive pressure between American companies, Chinese labs, and the open source community is driving quality up and cost down at a pace that benefits you. Today's best default is Claude Code. Tomorrow it might be something else. Your files do not care. That is what sovereignty means in this context, and it is worth thinking about as you decide which tools earn your trust and your money. For a deeper dive on sovereignty principles, see [Sovereign Agentic Business OS](/docs/sovereign-agentic-business-os).
...
- **The vision:** a living "company bible" (see [Start Your Company Bible](/docs/legacy/start-your-company-bible)) that everyone, human and AI, operates from. Continuously updated. Version-controlled. The single source of truth for how your organization works.
...
- [Legacy](/docs/legacy): The framework for documenting and organizing the truth your business OS draws on
- [Start Your Company Bible](/docs/legacy/start-your-company-bible): Scaling legacy across an organization
- [Make Your Company Refactorable](/docs/legacy/make-your-company-refactorable): Making your operation grep-able and editable by AI agents
- [Voice Transcriber](/docs/legacy/voice-transcriber): Deeper dive on the voice-to-text tools that power the brain dump workflow
