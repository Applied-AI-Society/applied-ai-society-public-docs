...
The Applied AI Society exists to make that ark-building as fast, as high-quality, and as sovereign as possible. Come [get Jarvised](/docs/get-jarvised). Bring the people you love.
...
- [Your Two Futures](/docs/philosophy/your-two-futures): The personal-level fork the flood forces on every individual.
- [Hyperagency](/docs/concepts/hyperagency): What the ascending side of the flood looks like as a personal state.
- [Activation](/docs/concepts/activation): How a person crosses from unprepared to ark-building in a single afternoon.
- [Personal Agentic OS](/docs/concepts/personal-agentic-os): The hull of the ark. Files on your computer that make the system yours.
