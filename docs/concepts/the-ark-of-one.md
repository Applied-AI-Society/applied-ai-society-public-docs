...
The AAS position is direct. In [the New Flood](/docs/concepts/the-new-flood), a properly built [Personal Agentic OS](/docs/concepts/personal-agentic-os) functions as a literal ark for the person who owns it. It is the vessel that keeps their agency, their livelihood, their creative output, and their capacity to help others afloat while the currents around them reshape the landscape.
...
Sovereign design means your context lives on your disk, not their server. The harness runs locally or in a configuration you control. The skill files are yours. The output is yours. The portability across providers is real. You use [Claude Code](/docs/tools/tool-setups/claude-code-setup), [Hermes](/docs/tools/tool-setups/hermes-setup), [Codex](/docs/tools/tool-setups/codex-setup), or whatever else best fits you, and if tomorrow you need to switch, you switch. Nothing is lost. See [The Sovereignty Stack](/docs/concepts/the-sovereignty-stack) for the layers this principle applies across, and [Progressive Sovereignty](/docs/concepts/progressive-sovereignty) for how to move toward full sovereignty over time without making yourself unable to do useful work in the meantime.
...
- **Carried the people they were responsible for.** A PAOS built well is shareable infrastructure for the people around its owner. Skill files, context patterns, workflows, [instruction files](/docs/concepts/instruction-files). One person's ark becomes the scaffold their team, their family, and their community can use to build their own.
...
- **Was built before the flood peaked.** The arks that matter were built while the water was still rising, not after. Every person who [gets Jarvised](/docs/get-jarvised) in 2026 is effectively laying the first planks of their ark well before the peak. Every person still "waiting to see how AI shakes out" in 2027 is going to be trying to build in a storm.

The claim is not decorative. The mechanics are the same.

## The Fleet

An ark of one is the starting vessel. It is not the end of the story. Every person with their own ark becomes a candidate to help the next person build theirs, which is how the **fleet** in [Either We Jarvis The World, Or AI Is Doomed](/docs/philosophy/jarvis-the-world-or-ai-is-doomed) actually gets built. Not centrally. One ark at a time, each one teaching the next.

Arks also scale. An ark of one becomes the foundation for arks of a team, a business, a community, or a city. Same architecture, same principles, more people on board. See [the arks-at-every-scale section](/docs/philosophy/jarvis-the-world-or-ai-is-doomed#arks-at-every-scale) for the full ladder.
...
- [Personal Agentic OS](/docs/concepts/personal-agentic-os): The concrete system that, when built well, becomes the ark.
- [The New Flood](/docs/concepts/the-new-flood): The moment the ark is for.
- [Context Lake](/docs/concepts/context-lake): The "sufficient context" condition, operationalized.
- [The Sovereignty Stack](/docs/concepts/the-sovereignty-stack): The "sovereign design" condition, across every layer.
- [Activation](/docs/concepts/activation): The "active use" condition, as a psychological and practical threshold.
- [Progressive Sovereignty](/docs/concepts/progressive-sovereignty): How to move toward fuller sovereignty without breaking your current ability to work.
- [Either We Jarvis The World, Or AI Is Doomed](/docs/philosophy/jarvis-the-world-or-ai-is-doomed): The fleet. Why one ark is not enough, and how they combine into the civilizational response to the New Flood.
- [Minimum Commercial Viability](/docs/concepts/minimum-commercial-viability): The economic floor an ark of one puts you above.
- [Capture, Process, Compound](/docs/concepts/capture-process-compound): The daily practice that keeps the ark seaworthy.
