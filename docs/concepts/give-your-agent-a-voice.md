...
*The most underrated upgrade to an agentic harness in 2026 is the one most practitioners have not tried yet. Add a voice channel and your agent stops being a screen you stare at and starts being a presence in your room. Here is why it matters, the architecture that works, and the right local default.*
...
- [Anatomy of a Harness](./anatomy-of-a-harness.md)
- [Agentic Harness](./agentic-harness.md)
- [Always-On Agents](./always-on-agents.md)
- [Conjoined Agency](./conjoined-agency.md)

*This concept is also documented in the Imagos trust-circle wiki.*
