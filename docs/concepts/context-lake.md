...
Your context lake is the structured collection of markdown files that your [Personal Jarvis](/docs/concepts/personal-jarvis) draws on to represent you, think alongside you, and act on your behalf. It is the persistent memory layer that makes the difference between a generic chatbot and a deeply contextualized AI chief of staff.
...
An AI with your context lake is a Jarvis. It knows the truth about your situation. It can generate briefings drawn from your actual relationships. It can draft communications in your actual voice. It can catch inconsistencies in your strategy because it has read every strategic document you have ever written. It compounds over time because every brain dump, every meeting transcript, every decision record adds to the lake.

The quality of your AI's output is directly proportional to the quality of your context lake. This is [context engineering](/docs/concepts/context-engineering) at the personal level: curating the right information so your AI can do the right work.
...
A context lake after a year is a genuine competitive advantage. No new hire, no consultant, no advisor can match the depth of context your Jarvis has accumulated. It is the closest thing to a perfect institutional memory that has ever existed.

This is what [compounding docs](/docs/concepts/compounding-docs) looks like in practice. Every file you add makes every other file more useful. The whole is greater than the sum of its parts.
...
A context lake is the opposite. It is structured, portable, permanent, and platform-independent. It is the [sovereign](/docs/sovereign-agentic-business-os) alternative to letting platforms own your context.

## Building Your Context Lake

The [Minimum Viable Jarvis](/docs/playbooks/practitioner/minimum-viable-jarvis) tutorial walks you through building your first context lake from scratch. The default structure is simple:
...
- **Personal context lake:** Your Jarvis workspace. Everything about you and your operation.
...
- **Organizational context lake:** The "company bible" ([start yours here](/docs/legacy/start-your-company-bible)). The living, version-controlled single source of truth for how the organization works.
...
- [Personal Jarvis](/docs/concepts/personal-jarvis): The system your context lake powers
- [Minimum Viable Jarvis](/docs/playbooks/practitioner/minimum-viable-jarvis): Build your first context lake
