...
**Build your harness around model-swap.** Model-loyalty is a 2024 pattern. *[See: Anatomy of a Harness](/docs/concepts/anatomy-of-a-harness) and [Learn the Harness, Not the Wrapper](/docs/concepts/learn-the-harness-not-the-wrapper) for the underlying principle.* The harness is the durable layer. The model rotates inside it.
...
**Hold confident outputs to a higher bar.** GPT-5.5 confidently produces incorrect work more often than its predecessor. The output looks right. It is wrong more often. Verify before shipping. *[See: The Overconfidence Trap](/docs/concepts/the-overconfidence-trap) for the operator-side mirror of this same pattern.*
...
*Related: [The Overconfidence Trap](the-overconfidence-trap.md) | [Anatomy of a Harness](anatomy-of-a-harness.md) | [Learn the Harness, Not the Wrapper](learn-the-harness-not-the-wrapper.md) | [The Case for Simple Harnesses](the-case-for-simple-harnesses.md) | [LLM Psychosis](llm-psychosis.md) | [Compound Drift](compound-drift.md)*
