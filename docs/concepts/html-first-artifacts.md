...
HTML is the upgrade. Same harness, same superprompt, same Jarvis. Just ask for the artifact in HTML and watch what changes.
...
Markdown does not render well in most browsers. To share a markdown artifact you usually have to import it somewhere first. See [sharing Jarvis artifacts](/docs/concepts/sharing-jarvis-artifacts) for the discipline around that.
...
- [Sharing Jarvis Artifacts](/docs/concepts/sharing-jarvis-artifacts): The publishing discipline once the artifact exists.
- [Compounding Docs](/docs/concepts/compounding-docs): Why every artifact should accumulate value over time.
- [Spec Writing](/docs/concepts/spec-writing): The artifact type that benefits most from the HTML upgrade.
- [Harness Engineering](/docs/concepts/harness-engineering): The harness producing these artifacts.
- [Superprompt](/docs/concepts/superprompt): The activated prompt that drives the artifact in the first place.
