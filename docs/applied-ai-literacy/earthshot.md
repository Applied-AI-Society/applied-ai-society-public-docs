...
description: "Our commitment: the best open-source applied AI literacy source material in the world, co-created by the leading practitioners in the world. The foundation from which all courses, tools, and translations derive."
---
...
Think of it the way [Legacy](/docs/legacy) works inside an organization: the documented truth is the foundation that every human and every AI agent builds from. Without it, you get scattered assumptions, contradictory advice, and coordination failures. With it, you get aligned action at scale.
...
**[The Writing on the Wall: The Rise of 'Applied AI' and the Life-or-Death Choice Every CEO Must Make Now](https://digitalcommons.humboldt.edu/digitallab/13/)** by  and Gary Sheng. The urgency behind the Earthshot: the numbers, the definition of applied AI, and why this is the greatest need.
