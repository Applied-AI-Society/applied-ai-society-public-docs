...
> **This is a senior advisory role.** The relationship is direct, between the advisor and the CEO. It exists alongside an internal Chief AI Officer or transformation team. For the embedded operator role, see [Chief AI Officer](./chief-ai-officer).
...
**Hands-on practitioner credibility.** The advisor has shipped real AI work. CEOs distinguish quickly between counsel that comes from someone who has built and counsel that comes from someone who has only read. See [applied AI practitioner](/docs/concepts/applied-ai-practitioner).
...
- [Chief AI Officer](./chief-ai-officer): the embedded operator role. Complementary to the Advisor.
- [Applied AI Practitioner](/docs/concepts/applied-ai-practitioner): the foundation an Advisor stands on.
- [Agentic Strategy](/docs/concepts/agentic-strategy): the strategic frame the Advisor brings to the table.
- [The Elevator Economy](/docs/concepts/the-elevator-economy): the macro context that makes the role urgent.
- [Minimum Commercial Viability](/docs/concepts/minimum-commercial-viability): the floor the Advisor helps the CEO clear at the company level.
